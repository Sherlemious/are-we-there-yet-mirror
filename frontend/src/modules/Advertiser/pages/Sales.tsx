  ...
  return (
    <div className="mx-8 my-8 space-y-6 rounded-lg bg-gray-50/60 p-6 shadow-lg">
      ...
      <div className="flex flex-col space-y-6">
        ...
        <div className="grid grid-cols-4 gap-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
          ...
          <div className="flex items-end">
            <button className="flex w-full items-center justify-center space-x-2 rounded-lg bg-accent-dark-blue px-4 py-2 text-white transition-colors duration-300 hover:bg-blue-700">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="none"
