  ...
  return (
    <div className="mx-7 flex flex-col gap-8">
      ...
      <div className="flex h-fit w-full flex-row justify-around border-2 bg-primary-green">
        ...
        <button
          className={`my-4 h-full w-fit self-center text-xl ${currentTab === "tour guide" ? "font-bold text-white" : "text-gray-900"} hover:text-white`}
          onClick={() => handleTabChange("tour guide")}
        >
          Tour Guides
        </button>
        <button
          className={`my-4 h-full w-fit self-center text-xl ${currentTab === "product" ? "font-bold text-white" : "text-gray-900"} hover:text-white`}
